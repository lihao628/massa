...
lazy_static::lazy_static! {
    ...
    pub static ref GENESIS_TIMESTAMP: MassaTime = MassaTime::from_millis(1696430553687);
...
pub const MAX_BOOTSTRAP_MESSAGE_SIZE: u32 = u32::MAX; //1048576000;
...
/// Max bytes in final states parts
pub const MAX_BOOTSTRAPPED_NEW_ELEMENTS_SIZE: u64 = 100_000_000;
